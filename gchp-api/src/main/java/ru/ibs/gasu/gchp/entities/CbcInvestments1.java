...
@Audited
@Entity
public class CbcInvestments1 implements Investments {
    @Id
    private Long id;
    ...
    private List<CbcInvestments1Indicator> indicators = new ArrayList<>();
    ...
    public List<CbcInvestments1Indicator> getIndicators() {
        return indicators;
    }

    public void setIndicators(List<CbcInvestments1Indicator> indicators) {
    ...
    public boolean equals(Object o) {
        ...
        CbcInvestments1 that = (CbcInvestments1) o;
