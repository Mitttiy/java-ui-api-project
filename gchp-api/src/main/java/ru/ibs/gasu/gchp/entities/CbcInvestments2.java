...
@Audited
@Entity
public class CbcInvestments2 implements Investments {
    @Id
    private Long id;
    ...
    private List<CbcInvestments2Indicator> indicators = new ArrayList<>();
    ...
    public List<CbcInvestments2Indicator> getIndicators() {
        return indicators;
    }

    public void setIndicators(List<CbcInvestments2Indicator> indicators) {
    ...
    public boolean equals(Object o) {
        ...
        CbcInvestments2 that = (CbcInvestments2) o;
