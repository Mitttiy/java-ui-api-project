...
@Audited
@Entity
public class CbcInvestments3 implements Investments {
    @Id
    private Long id;
    ...
    private List<CbcInvestments3Indicator> indicators = new ArrayList<>();
    ...
    public List<CbcInvestments3Indicator> getIndicators() {
        return indicators;
    }

    public void setIndicators(List<CbcInvestments3Indicator> indicators) {
    ...
    public boolean equals(Object o) {
        ...
        CbcInvestments3 that = (CbcInvestments3) o;
