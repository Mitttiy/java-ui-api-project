...
@Audited
@Entity
public class CbcInvestments4 implements Investments {
    @Id
    private Long id;
    ...
    private List<CbcInvestments4Indicator> indicators = new ArrayList<>();
    ...
    public List<CbcInvestments4Indicator> getIndicators() {
        return indicators;
    }

    public void setIndicators(List<CbcInvestments4Indicator> indicators) {
    ...
    public boolean equals(Object o) {
        ...
        CbcInvestments4 that = (CbcInvestments4) o;
