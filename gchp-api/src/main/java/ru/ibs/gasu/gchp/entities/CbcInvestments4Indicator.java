...
@Audited
@Entity
public class CbcInvestments4Indicator implements InvestmentIndicator {
    @Id
    ...
    @ManyToOne
    @JoinColumn(name = "cbc_investments4")
    @XmlTransient
    private CbcInvestments4 investments;

    @OneToMany(mappedBy = "investmentIndicator", cascade = CascadeType.ALL, orphanRemoval = true)
    private List<CbcInvestments4IndicatorYearValue> valuesByYears = new ArrayList<>();
    ...
    @XmlTransient
    public CbcInvestments4 getInvestments() {
        return investments;
    }

    public void setInvestments(CbcInvestments4 planInvestments) {
        this.investments = planInvestments;
    }

    public List<CbcInvestments4IndicatorYearValue> getValuesByYears() {
        return valuesByYears;
    }

    public void setValuesByYears(List<CbcInvestments4IndicatorYearValue> valuesByYears) {
    ...
    public boolean equals(Object o) {
        ...
        CbcInvestments4Indicator that = (CbcInvestments4Indicator) o;
