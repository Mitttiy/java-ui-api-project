...
@Audited
@Entity
public class CreationInvestments implements Investments {
    @Id
    private Long id;
    ...
    private List<CreationInvestmentIndicator> indicators = new ArrayList<>();
    ...
    public List<CreationInvestmentIndicator> getIndicators() {
        return indicators;
    }

    public void setIndicators(List<CreationInvestmentIndicator> indicators) {
    ...
    public boolean equals(Object o) {
        ...
        CreationInvestments that = (CreationInvestments) o;
