...
public class ExBankGuarantee {
    ...
    private List<ExBankGuaranteeByYears> valuesByYears = new ArrayList<>();
    ...
    public List<ExBankGuaranteeByYears> getValuesByYears() {
        return valuesByYears;
    }

    public void setValuesByYears(List<ExBankGuaranteeByYears> valuesByYears) {
    ...
    public boolean equals(Object o) {
        ...
        ExBankGuarantee that = (ExBankGuarantee) o;
