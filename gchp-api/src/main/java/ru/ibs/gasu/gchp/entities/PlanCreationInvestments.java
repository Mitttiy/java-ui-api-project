...
@Audited
@Entity
public class PlanCreationInvestments implements Investments {
    @Id
    private Long id;
    ...
    private List<PlanCreationInvestmentIndicator> indicators = new ArrayList<>();
    ...
    public List<PlanCreationInvestmentIndicator> getIndicators() {
        return indicators;
    }

    public void setIndicators(List<PlanCreationInvestmentIndicator> indicators) {
    ...
    public boolean equals(Object o) {
        ...
        PlanCreationInvestments that = (PlanCreationInvestments) o;
