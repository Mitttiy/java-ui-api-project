...
@Audited
@Entity
public class RemainingDebt implements Investments {
    @Id
    private Long id;
    ...
    private List<RemainingDebtIndicator> indicators = new ArrayList<>();
    ...
    public List<RemainingDebtIndicator> getIndicators() {
        return indicators;
    }

    public void setIndicators(List<RemainingDebtIndicator> indicators) {
    ...
    public boolean equals(Object o) {
        ...
        RemainingDebt that = (RemainingDebt) o;
