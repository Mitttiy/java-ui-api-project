...
public class CircumstancesAdditionalCostsDicWindow extends Window {

    private Grid<SimpleIdNameModel> grid;
    private ListStore<SimpleIdNameModel> store;

    public CircumstancesAdditionalCostsDicWindow(List<SimpleIdNameModel> dic, List<SimpleIdNameModel> selected) {
        this.setModal(true);
        ...
        SafeHtml headerText = new SafeHtmlBuilder()
                .appendHtmlConstant("<b><h3>Выберите обстоятельства</h3></b>").toSafeHtml();
        ...
        container.add(createGrid(dic, selected), new VerticalLayoutContainer.VerticalLayoutData(-1, 0.9));
        ...
        saveButton = new IconButton(
            ...
            protected void onClick(Event event) {
                ...
                CircumstancesAdditionalCostsDicWindow.this.hide();
            }
        };
    ...
    private Grid<SimpleIdNameModel> createGrid(List<SimpleIdNameModel> dic, List<SimpleIdNameModel> selected) {
        ...
        selectionModel.select(selected, false);
