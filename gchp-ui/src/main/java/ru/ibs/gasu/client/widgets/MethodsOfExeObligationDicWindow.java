...
public class MethodsOfExeObligationDicWindow extends Window {
    ...
    public MethodsOfExeObligationDicWindow() {
        this.setModal(true);
        ...
        SafeHtml headerText = new SafeHtmlBuilder()
                .appendHtmlConstant("<b><h3>Выберите способы обеспечения</h3></b>").toSafeHtml();
        ...
        saveButton = new IconButton(
            ...
            protected void onClick(Event event) {
                ...
                MethodsOfExeObligationDicWindow.this.hide();
            }
        };
